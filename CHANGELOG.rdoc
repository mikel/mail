...
* #681 - Performance: fewer hotspot object allocations (srawlins)
* #745 - Added support for the null envelope sender, per RFC 3464 (raindrift)
...
== Version 2.6.2 - Wed 13:42 -0500 2014 Benjamin Fleischer <github@benjaminfleischer.com>
